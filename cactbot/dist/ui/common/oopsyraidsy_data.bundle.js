...
;// CONCATENATED MODULE: ./ui/oopsyraidsy/data/07-dt/trial/shinryu-un.ts
// This file was autogenerated from running npm run sync-files.
// DO NOT EDIT THIS FILE DIRECTLY.
// Edit the source file below and then run `npm run sync-files`
...
const shinryu_un_triggerSet = {
  ...
  damageWarn: {
    'ShinryuUn Burning Chains': 'C45E',
    // not breaking chains fast enough
    'ShinryuUn Icicle Icicle Impact': 'C44B',
    // icicles landing
    'ShinryuUn Icicle Spikesicle': 'C44C',
    // icicle dash
    'ShinryuUn Tail Slap': 'C43E',
    // tail add appearing
    'ShinryuUn Dragonfist': 'C46D',
    // giant punchy circle in the center.
    'ShinryuUn Gyre Charge': 'C45F',
    // phase 1 large dive attack
    'ShinryuUn Ginryu Fireball': 'C467',
    // targeted circle during add phase
    'ShinryuUn Hakkinryu Blazing Trail': 'C465',
    // wide line during add phase
    'ShinryuUn Tail Spit': 'BC2D',
    // blue puck during knockback
    'ShinryuUn Aetherial Ray': 'C474',
    // lasers while running along the tail
    'ShinryuUn Levinbolt': 'C486',
    // baited lightning during final phase
    'ShinryuUn Wormwail': 'C475',
    // donut attack
    'ShinryuUn Benighting Breath': 'C477' // 90 degree conal attack
  },

  shareWarn: {
    'ShinryuUn Levinbolt Spread': 'C446',
    // untelegraphed lightning spread
    'ShinryuUn Earth Breath': 'C449' // earthshaker-esque conal attacks
  },

  soloWarn: {
    'ShinryuUn Hypernova': 'C445',
    // stack in puddle damage

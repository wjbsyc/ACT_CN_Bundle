...
const data = {
  '13th Child': {
    ...
    'name': {
      'cn': '第十三个孩子',
      'de': ['Dreizehnte Kind', 'Dreizehnter Kind', 'Dreizehntes Kind'],
      'en': '13th Child',
      'fr': 'treizième enfant',
      'ja': 'サーティーンス・チャイルド',
      'ko': '열셋째 아이',
  ...
  'Atticus the Primogenitor': {
    ...
    'name': {
      'cn': '先驱勇士 阿提卡斯',
      'de': ['Atticus der Primogenitor', 'Atticus die Primogenitor', 'Atticus das Primogenitor'],
  ...
  'Kirlirger the Abhorrent': {
    ...
    'name': {
      'cn': '厌忌之人 奇里格',
      'de': ['Kirlirger der Abscheuliche', 'Kirlirger der Abscheulicher', 'Kirlirger der Abscheuliches', 'Kirlirger die Abscheuliche', 'Kirlirger die Abscheulicher', 'Kirlirger die Abscheuliches', 'Kirlirger das Abscheuliche', 'Kirlirger das Abscheulicher', 'Kirlirger das Abscheuliches'],
  ...
  'Sally the Sweeper': {
    ...
    'name': {
      'cn': '清扫者萨莉',
      'de': ['Sally der Fegerin', 'Sally die Fegerin', 'Sally das Fegerin'],
  ...
  'crystal incarnation': {
    ...
    'name': {
      'cn': '水晶化身',
      'de': ['inkarnierte Kristallisation', 'inkarnierter Kristallisation', 'inkarniertes Kristallisation'],
  ...
  'mad maguey': {
    ...
    'name': {
      'cn': '疯狂龙舌兰',
      'de': ['aggressive Agave', 'aggressiver Agave', 'aggressives Agave'],
      'en': 'mad maguey',
      'fr': 'pita dément',
      'ja': 'マッドマゲイ',
      'ko': '미친 용설란',
...
const instanceChangedRegexes = {
  ...
  tc: netregexes/* default.gameLog */.ZP.gameLog({
    code: '0039',
    line: '目前所在副本區為.*?'
  })
};

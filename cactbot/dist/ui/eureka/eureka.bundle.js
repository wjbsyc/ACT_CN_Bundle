...
const data = {
  ...
  136: {
    'rates': [15, 85, 100],
    'weathers': ['Astromagnetic Storms', 'Fair Skies', 'Umbral Wind']
  },
  137: {
  ...
  159: {
    'rates': [40, 80, 85, 95, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Fog', 'Rain']
  },
  160: {
    'rates': [20, 50, 70, 80, 90, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Fog', 'Wind', 'Snow']
  },
  161: {
    'rates': [25, 60, 75, 85, 95, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Fog', 'Rain', 'Showers']
  },
  162: {
    'rates': [15, 55, 70, 85, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Fog', 'Rain']
  },
  163: {
    'rates': [100],
  ...
  164: {
    'rates': [5, 50, 70, 85, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Dust Storms', 'Gales']
  },
  165: {
    'rates': [5, 25, 40, 45, 50, 100],
    'weathers': ['Fair Skies', 'Clouds', 'Fog', 'Rain', 'Thunderstorms', 'Umbral Static']
  },
  166: {
    'rates': [10, 20, 40, 100],
    'weathers': ['Rain', 'Fog', 'Clouds', 'Fair Skies']
  },
  167: {
    'rates': [100],
    'weathers': ['Electrostatic Dust']
  },
  168: {
    'rates': [10, 55, 70, 80, 95, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Rain', 'Atmospheric Phantasms', 'Illusory Disturbances']
  },
  169: {
    'rates': [15, 85, 100],
    'weathers': ['Moon Dust', 'Fair Skies', 'Umbral Wind']
  },
  170: {
    'rates': [100],
    'weathers': ['Dying Breath']
  },
  171: {
    'rates': [60, 80, 100],
    'weathers': ['Fair Skies', 'Clouds', 'Rain']
  },
  172: {
    'rates': [20, 80, 100],
    'weathers': ['Clouds', 'Fair Skies', 'Clear Skies']
...
;// CONCATENATED MODULE: ./ui/eureka/southhorn.png
const southhorn_namespaceObject = __webpack_require__.p + "ui/eureka/southhorn.png";
  ...
  Regex: {
    ...
    en: {
      flagRegex: netregexes/* default.gameLog */.ZP.gameLog({
        code: '00..',
        line: `(?<before>.*)\ue0bb(?:${areaNames}) \\( (?<x>\\y{Float})\\s*, (?<y>\\y{Float}) \\)(?<after>.*?)`
      }),
